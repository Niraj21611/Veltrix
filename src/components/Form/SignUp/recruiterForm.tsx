...
import { Building2, MapPin, Briefcase, Linkedin, Globe } from "lucide-react"
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="e.g., HR Manager, Talent Acquisition Specialist" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Enter company street address" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
